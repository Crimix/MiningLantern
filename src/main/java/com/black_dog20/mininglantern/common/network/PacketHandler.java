package com.black_dog20.mininglantern.common.network;
...
public class PacketHandler {
	...
	public static final SimpleChannel NETWORK = NetworkRegistry.ChannelBuilder
			.named(new ResourceLocation(MiningLantern.MOD_ID, "network"))
	...
	public static void register() {
		registerMessage(MessageSyncLanternCapability.class, MessageSyncLanternCapability::encode, MessageSyncLanternCapability::decode, MessageSyncLanternCapability.Handler::handle);
		registerMessage(MessageUpdateLanternState.class, MessageUpdateLanternState::encode, MessageUpdateLanternState::decode, MessageUpdateLanternState.Handler::handle);
	}
